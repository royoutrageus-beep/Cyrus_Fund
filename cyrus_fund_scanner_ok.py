...
def _pf(price, compact=False):
    """Smart price formatter untuk crypto: BTC ($95,432) sampai SHIB ($0.000021)."""
    try:
        p = float(price)
        if p <= 0: return "0"
...
st.set_page_config(layout="wide", page_title="Mesin Presisi CRYPTO v1.0", page_icon="⚡", initial_sidebar_state="collapsed")
...
# ════════════════════════════════════════════════════
raw_stocks = [
    # ── TIER 1: MAJOR (Top 20 by market cap) ──
    "BTC-USD","ETH-USD","BNB-USD","SOL-USD","XRP-USD","ADA-USD","DOGE-USD","AVAX-USD",
    "TRX-USD","TON11419-USD","LINK-USD","DOT-USD","NEAR-USD","MATIC-USD","ICP-USD","SHIB-USD",
    "LTC-USD","BCH-USD","UNI7083-USD","XLM-USD","HBAR-USD","ETC-USD","ATOM-USD","XMR-USD",
    # ── L1 / SMART CONTRACT PLATFORMS ──
    "SOL-USD","ADA-USD","AVAX-USD","NEAR-USD","DOT-USD","ATOM-USD","ALGO-USD","FTM-USD",
    "EGLD-USD","FLOW-USD","KAS-USD","ETC-USD","HBAR-USD","KAVA-USD","INJ-USD","SEI-USD",
    "SUI-USD","APT21794-USD","MINA-USD","ROSE-USD","ONE-USD","IOTA-USD","ZIL-USD","NEO-USD",
    "WAVES-USD","ICX-USD","QTUM-USD","ONT-USD","CKB-USD","XTZ-USD","EOS-USD","TRX-USD",
    # ── L2 / SCALING ──
    "ARB11841-USD","OP-USD","MATIC-USD","IMX10603-USD","MNT-USD","STRK22691-USD","METIS-USD","BOBA-USD",
    "LRC-USD","SKL-USD","MASK-USD","ZRO-USD",
    # ── DEFI ──
    "UNI7083-USD","AAVE-USD","MKR-USD","COMP5692-USD","SNX-USD","SUSHI-USD","CRV-USD","BAL-USD",
    "YFI-USD","DYDX-USD","GMX-USD","1INCH-USD","CAKE-USD","KNC-USD","BAND-USD","RUNE-USD",
    "OSMO-USD","STX4847-USD","JUP29210-USD","RAY-USD","JTO-USD","PYTH-USD",
    # ── MEMECOIN ──
    "DOGE-USD","SHIB-USD","PEPE24478-USD","FLOKI-USD","BONK-USD","WIF-USD","MEME28301-USD","BRETT29743-USD",
    "BOOK-USD","TURBO24911-USD","MEW-USD","POPCAT-USD","NEIRO-USD","PNUT-USD","GOAT-USD","ACT-USD",
    # ── PRIVACY ──
    "XMR-USD","ZEC-USD","DASH-USD","FIRO-USD","BEAM-USD","SCRT-USD","DERO-USD",
    # ── STORAGE / INFRASTRUCTURE ──
    "FIL-USD","AR-USD","STX4847-USD","SC-USD","BTT-USD","RNDR-USD","AKT-USD","THETA-USD",
    "GRT6719-USD","STORJ-USD","HOT-USD","ANKR-USD","API3-USD",
    # ── AI ──
    "FET-USD","AGIX-USD","OCEAN-USD","RNDR-USD","NEAR-USD","INJ-USD","TAO22974-USD","IO29796-USD",
    "WLD-USD","NMR-USD","ICP-USD","CTXC-USD","NUM-USD","ATH-USD",
    # ── GAMING / METAVERSE ──
    "SAND-USD","MANA-USD","AXS-USD","ENJ-USD","GALA-USD","IMX10603-USD","GAL-USD","MAGIC-USD",
    "PRIME-USD","BIGTIME-USD","SUPER8290-USD","ALICE-USD","SLP-USD","ILV-USD","YGG-USD","UFO-USD",
    "VRA-USD","PIXEL-USD","MAVIA-USD","XAI28200-USD",
    # ── NFT / SOCIAL ──
    "APE18876-USD","BLUR-USD","LOOKS-USD","DEGEN-USD","CTSI-USD","CHZ-USD","FLOW-USD","WAX-USD",
    "AUDIO-USD","FRIEND-USD",
    # ── EXCHANGE TOKENS ──
    "BNB-USD","OKB-USD","KCS-USD","BGB-USD","GT-USD","CRO-USD","FTT-USD","LEO-USD",
    "HT-USD","MX-USD",
    # ── ORACLE / DATA ──
    "LINK-USD","BAND-USD","API3-USD","TRB-USD","PYTH-USD","UMA-USD","DIA-USD",
    # ── DEPIN / RWA ──
    "RNDR-USD","HNT-USD","IOTX-USD","HONEY-USD","JASMY-USD","GAL-USD","ONDO-USD","POLYX-USD",
    # ── BITCOIN ECOSYSTEM ──
    "BTC-USD","STX4847-USD","ORDI-USD","SATS29796-USD","PUPS-USD","RUNE-USD","WBTC-USD",
    # ── SOL ECOSYSTEM ──
    "SOL-USD","JUP29210-USD","JTO-USD","WIF-USD","BONK-USD","RAY-USD","PYTH-USD","TNSR-USD",
    "MEW-USD","POPCAT-USD","WEN-USD","PYUSD-USD",
    # ── COSMOS ECOSYSTEM ──
    "ATOM-USD","OSMO-USD","INJ-USD","TIA22861-USD","KAVA-USD","CRO-USD","RUNE-USD","DYDX-USD",
    "AKT-USD","SEI-USD","CELESTIA-USD",
    # ── STABLECOINS REFERENCE (low vol baseline) ──
    "USDT-USD","USDC-USD","DAI-USD","USDS33039-USD","FDUSD-USD",
    # ── NEWER LISTINGS (2024-2025) ──
    "TIA22861-USD","JUP29210-USD","STRK22691-USD","PYTH-USD","DYM-USD","ENA-USD","ETHFI-USD",
    "JTO-USD","ALT-USD","MANTA-USD","SAGA32859-USD","WLD-USD","OMNI-USD","AEVO-USD",
    "TAIKO-USD","ZKL-USD","ZRO-USD","ZK-USD","BB31254-USD","NOT32457-USD","SUNDOG-USD","CATI-USD",
    # ── WRAPPED / BRIDGE ──
    "WBTC-USD","WETH-USD","CBETH-USD","STETH-USD","RETH-USD",
    # ── ETH ECOSYSTEM ──
    "ETH-USD","UNI7083-USD","AAVE-USD","MKR-USD","LDO-USD","RPL-USD","ETHFI-USD","ENS-USD",
    "FRAX-USD","FXS-USD","CVX-USD","COMP5692-USD",
    # ── LIQUID STAKING ──
    "LDO-USD","RPL-USD","FXS-USD","ETHX-USD","SWELL-USD",
]
...
def get_market_regime():
    try:
        ...
        if above_e20_clear and above_e55:
            return ("GREEN", price, ema20, ema55, f"BTC {price:,.0f} > EMA20 & EMA55 → Bullish ✅ ({pct_vs_e20:+.1f}% vs EMA20)", chg)
        elif above_e20_any and above_e55:
            return ("GREEN", price, ema20, ema55, f"BTC {price:,.0f} dekat EMA20 & di atas EMA55 → Bullish", chg)
        elif above_e20_any and not above_e55:
            return ("SIDEWAYS", price, ema20, ema55, f"BTC {price:,.0f} > EMA20 tapi < EMA55({ema55:,.0f}) → Sideways", chg)
        elif not above_e20_any and recovering:
            return ("SIDEWAYS", price, ema20, ema55, f"BTC {price:,.0f} recovery {chg:+.2f}% → Sideways", chg)
        elif bearish_confirm:
            return ("RED", price, ema20, ema55, f"BTC {price:,.0f} < EMA20({ema20:,.0f}) {pct_vs_e20:+.1f}% → Bearish", chg)
        else:
            return ("SIDEWAYS", price, ema20, ema55, f"BTC {price:,.0f} sedikit di bawah EMA20 → Sideways", chg)
...
def get_regime_config(regime):
    ...
    return {
        "RED":     {"mode":"Reversal 🎯","min_score":3,"min_rvol":1.2,"sl_mult":1.0,
                    ...
                    "desc":"BTC < EMA20. Cari oversold bounce di altcoin. SL wider untuk volatilitas crypto."},
        "GREEN":   {"mode":"Bagger 💎","min_score":3,"min_rvol":1.3,"sl_mult":1.2,
                    "label":"🟢 BTC BULLISH — Altseason Setup, Score ≥ 3","color":"#00ff88",
                    "desc":"BTC > EMA20 & EMA55. Altcoin rotation, breakout pattern."},
        "SIDEWAYS":{"mode":"Scalping ⚡","min_score":3,"min_rvol":1.3,"sl_mult":1.0,
                    "label":"🟡 BTC SIDEWAYS — Range Scalp, RVOL ≥ 1.3x","color":"#ffb700",
                    "desc":"BTC choppy. Scalp di support/resistance, cari momentum altcoin."},
        "UNKNOWN": {"mode":"Scalping ⚡","min_score":2,"min_rvol":1.0,"sl_mult":1.0,
...
def send_telegram(results_top, source="Scanner"):
    ...
    footer=f"\n{sep}\n⚡ _Mesin Presisi CRYPTO v1.0 · TT 15M × IQ Daily_\n⚠️ _BUKAN saran investasi!_"
    try:
...
SECTORS={
    "Top 10 Major":       ["BTC-USD","ETH-USD","BNB-USD","SOL-USD","XRP-USD","ADA-USD","DOGE-USD","AVAX-USD","TRX-USD","LINK-USD"],
    "L1 Smart Contract":  ["SOL-USD","ADA-USD","AVAX-USD","NEAR-USD","DOT-USD","ATOM-USD","ALGO-USD","FTM-USD","EGLD-USD","SUI-USD","APT21794-USD","ICP-USD","INJ-USD","SEI-USD","TIA22861-USD","KAS-USD"],
    "L2 / Scaling":       ["ARB11841-USD","OP-USD","MATIC-USD","IMX10603-USD","MNT-USD","STRK22691-USD","METIS-USD","ZK-USD","ZRO-USD","TAIKO-USD"],
    "DeFi Blue Chips":    ["UNI7083-USD","AAVE-USD","MKR-USD","LDO-USD","CRV-USD","SNX-USD","COMP5692-USD","SUSHI-USD","DYDX-USD","GMX-USD","CAKE-USD","RUNE-USD","JTO-USD","ENS-USD"],
    "Memecoin":           ["DOGE-USD","SHIB-USD","PEPE24478-USD","FLOKI-USD","BONK-USD","WIF-USD","BRETT29743-USD","MEW-USD","POPCAT-USD","NEIRO-USD","PNUT-USD","GOAT-USD","TURBO24911-USD"],
    "AI Tokens":          ["FET-USD","AGIX-USD","OCEAN-USD","RNDR-USD","TAO22974-USD","IO29796-USD","WLD-USD","NEAR-USD","INJ-USD","NMR-USD"],
    "Gaming & Metaverse": ["SAND-USD","MANA-USD","AXS-USD","ENJ-USD","GALA-USD","IMX10603-USD","MAGIC-USD","PRIME-USD","BIGTIME-USD","ILV-USD","SLP-USD","SUPER8290-USD","PIXEL-USD"],
    "Privacy Coins":      ["XMR-USD","ZEC-USD","DASH-USD","FIRO-USD","BEAM-USD","SCRT-USD","DERO-USD"],
    "Oracle & Data":      ["LINK-USD","BAND-USD","API3-USD","TRB-USD","PYTH-USD","UMA-USD","GRT6719-USD"],
    "DePIN / RWA":        ["RNDR-USD","HNT-USD","IOTX-USD","JASMY-USD","ONDO-USD","POLYX-USD","AKT-USD","FIL-USD"],
    "Solana Ecosystem":   ["SOL-USD","JUP29210-USD","JTO-USD","WIF-USD","BONK-USD","RAY-USD","PYTH-USD","TNSR-USD","MEW-USD","POPCAT-USD"],
    "Cosmos Ecosystem":   ["ATOM-USD","OSMO-USD","INJ-USD","TIA22861-USD","KAVA-USD","DYDX-USD","AKT-USD","SEI-USD"],
    "Bitcoin Ecosystem":  ["BTC-USD","STX4847-USD","ORDI-USD","SATS29796-USD","WBTC-USD","RUNE-USD"],
    "Ethereum L2":        ["ARB11841-USD","OP-USD","MATIC-USD","IMX10603-USD","BLUR-USD","LDO-USD","LRC-USD","ETHFI-USD"],
    "Liquid Staking":     ["LDO-USD","RPL-USD","FXS-USD","STETH-USD","RETH-USD","CBETH-USD","ETHFI-USD","SWELL-USD"],
    "NFT / Social":       ["APE18876-USD","BLUR-USD","LOOKS-USD","DEGEN-USD","CHZ-USD","AUDIO-USD"],
    "Exchange Tokens":    ["BNB-USD","OKB-USD","KCS-USD","BGB-USD","GT-USD","CRO-USD","LEO-USD"],
    "Storage":            ["FIL-USD","AR-USD","STORJ-USD","SC-USD","BTT-USD"],
    "New 2024-2025":      ["WLD-USD","ENA-USD","STRK22691-USD","PYTH-USD","DYM-USD","ETHFI-USD","JUP29210-USD","ALT-USD","MANTA-USD","SAGA32859-USD","TIA22861-USD","AEVO-USD","OMNI-USD","ZK-USD","ZRO-USD"],
    "Stablecoins":        ["USDT-USD","USDC-USD","DAI-USD","FDUSD-USD","PYUSD-USD"],
}
HIGH_BETA_SECTORS=["Memecoin","AI Tokens","Gaming & Metaverse","New 2024-2025","Solana Ecosystem"]
...
st.markdown(f"""<div class="tt-header">
  ...
  <div class="tt-sub">TT 15M × Crypto Quant Daily (151 Strategies) · v1.0 · Zero Rate Limit ✅</div></div>
...
tab_scanner,tab_watchlist,tab_bsjp,tab_sector,tab_gapup,tab_trail,tab_backtest=st.tabs(
    ["🔥 Scanner","👁️ Watchlist","🌙 24H Play","🏭 Sektor","📈 Gap Up","🎯 Trailing Stop","📊 Backtest"])
...
<div style="background:linear-gradient(135deg,rgba(0,255,136,.04),rgba(191,95,255,.04));border:1px solid rgba(0,255,136,.25);border-radius:10px;padding:12px 16px;margin-bottom:12px;">
  <div style="font-family:Space Mono,monospace;font-size:11px;font-weight:700;color:#00ff88;letter-spacing:2px;margin-bottom:10px;">
    MESIN PRESISI CRYPTO v1.0 — 15M x DAILY ALIGNMENT (151 Strategies)
  </div>
...
with tab_bsjp:
    ...
    with bc1:
        bsjp_min_score=st.slider("Min 24H Score",0,6,4,key="bsjp_score")
        bsjp_min_rvol=st.slider("Min RVOL",1.0,5.0,1.5,0.1,key="bsjp_rvol")
    with bc2:
        bsjp_min_turn=st.number_input("Min Turnover (M USD)",value=5,step=1,key="bsjp_turn")*1_000_000
    do_bsjp=st.button("🌙 SCAN 24H SEKARANG",type="primary",use_container_width=True,key="btn_bsjp")
    if do_bsjp:
        bsjp_res=[]; scan_data=st.session_state.get("data_dict",{})
        if not scan_data:
            st.info("Fetching data untuk 24H play...")
    ...
    if br:
        ...
        st.markdown('<div style="text-align:center;padding:48px;color:#4a5568;font-family:Space Mono,monospace;"><div style="font-size:32px;margin-bottom:12px;">🌙</div><div>KLIK SCAN 24H</div></div>',unsafe_allow_html=True)
...
with tab_trail:
    ...
    with tc1:
        ...
        tr_t=st.text_input("Ticker",value="BTC-USD",key="tr_ticker").upper()
...
st.markdown(f"""<div style="margin-top:28px;padding-top:14px;border-top:1px solid #1c2533;display:flex;justify-content:space-between;flex-wrap:wrap;gap:8px;">
  <div style="font-family:Space Mono,monospace;font-size:10px;color:#4a5568;">🔥 Mesin Presisi CRYPTO v1.0 · TT 15M × Crypto Quant (151 Strategies) · Zero Rate Limit ✅</div>
